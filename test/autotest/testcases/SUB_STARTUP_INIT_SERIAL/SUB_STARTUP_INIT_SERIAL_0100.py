...
class SUB_STARTUP_INIT_SERIAL_0100(TestCase):
    ...
    def process(self):
        ...
        hap_path = Common.sourcepath('Normal.hap', "SUB_STARTUP_INIT_SERIAL")
        bundle_name = "com.example.normal"
        ...
        for deviceinfo in ['  serial: ', '  udid: ']:
            self.driver.Assert.contains(deviceinfo_list, deviceinfo)

    def teardown(self):
        Step("收尾工作.................")
        self.driver.AppManager.uninstall_app("com.example.normal")