...
class SubStartupInitCaniuse1000(TestCase):
    ...
    def process(self):
        ...
        bundle_name = "com.example.myapplication4"
    ...
    def teardown(self):
        Step("收尾工作.................")
        self.driver.AppManager.clear_app_data("com.example.myapplication4")
        self.driver.AppManager.uninstall_app("com.example.myapplication4")
