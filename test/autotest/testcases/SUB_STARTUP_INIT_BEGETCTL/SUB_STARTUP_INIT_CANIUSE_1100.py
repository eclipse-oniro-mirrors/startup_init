...
class SubStartupInitCaniuse1100(TestCase):
    ...
    def process(self):
        ...
        bundle_name = "com.example.myapplication5"
    ...
    def teardown(self):
        Step("收尾工作.................")
        self.driver.AppManager.clear_app_data("com.example.myapplication5")
        self.driver.AppManager.uninstall_app("com.example.myapplication5")
