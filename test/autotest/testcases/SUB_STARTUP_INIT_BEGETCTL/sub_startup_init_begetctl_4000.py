...
class SunStartupInitBegetctl4000(TestCase):
    ...
    def test_step1(self):
        ...
        self.driver.shell('begetctl service_control restart hiview')
        sleep(2)
        Step("检查服务状态.................")
        pid_restart = self.driver.System.get_pid("hiview")
        Step(pid_restart)
        sleep(1)
        Step("再次执行service_control stop hiview.................")
        self.driver.shell('begetctl service_control stop hiview')
        sleep(2)
        Step("再次执行service_control start hiview.................")
        self.driver.shell('begetctl service_control start hiview')
        sleep(2)
        Step("最终检查服务状态.................")
        pid_final = self.driver.System.get_pid("hiview")
        Step(pid_final)
