...
class SUB_STARTUP_INIT_SERMGT_0600(TestCase):
    ...
    def test_step1(self):
        ...
        Step("查看param_watcher服务状态..........................")
        result_be = self.driver.shell('ps -Al | grep param_watcher')
        Step(result_be)
        ...
        sleep(3)
        Step("查看param_watcher服务状态..........................")
        result_af = self.driver.shell('ps -Al | grep param_watcher')
        Step(result_af)
        assert result_af == ''
