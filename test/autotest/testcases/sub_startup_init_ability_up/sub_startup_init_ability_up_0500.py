...
class SubStartupInitAbilityUp0500(TestCase):
    ...
    def test_step1(self):
        ...
        self.driver.pull_file(devpath, "testFile/sub_startup_init_ability_up/param_watcher.cfg")
        Step("修改本地系统文件..........................")
        lines1 = []
        path2 = os.path.join(os.path.dirname(os.path.dirname(os.path.dirname(__file__))),
                             "testFile\sub_startup_init_ability_up")
        local_path = os.path.join(path2, "param_watcher.cfg")
