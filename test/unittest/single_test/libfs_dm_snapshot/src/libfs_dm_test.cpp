...
{
    InitdmioFunc initDmio = [](struct dm_ioctl *, const char *) -> int {
        return -1;
    };
    UpdateInitdmioFunc(initDmio);
...
HWTEST_F(LibFsDmTest, LoadDmDeviceTable_005, TestSize.Level0)
{
    ...
    int ret = LoadDmDeviceTable(FD_ID, "devname", &target, dmTpyeIndex);
    EXPECT_EQ(ret, -1);
    ret = LoadDmDeviceTable(FD_ID, "devname", &target, dmTpyeIndex);
    EXPECT_EQ(ret, -1);
    UpdateStrcpySFunc(nullptr);
    UpdateInitdmioFunc(nullptr);
    free(target.paras);
...
HWTEST_F(LibFsDmTest, FsDmCreateDevice_002, TestSize.Level0)
{
    ...
    UpdateOpenFunc(openFunc);
    CreatedmdevFunc createDmDevFunc = [](int, const char*) -> int {
        return -1;
    };
    UpdateCreatedmdevFunc(createDmDevFunc);
    char *dmDevPath = nullptr;
    int ret = FsDmCreateDevice(&dmDevPath, "devname", nullptr);
    UpdateOpenFunc(nullptr);
...
HWTEST_F(LibFsDmTest, FsDmCreateDevice_003, TestSize.Level0)
{
    ...
    UpdateCreatedmdevFunc(createDmDevFunc);
    LoaddmdevicetableFunc loadDmFunc = [](int, const char *, DmVerityTarget *, int) -> int {
        return -1;
    };
    UpdateLoaddmdevicetableFunc(loadDmFunc);
    char *dmDevPath = nullptr;
    int ret = FsDmCreateDevice(&dmDevPath, "devname", nullptr);
    UpdateOpenFunc(nullptr);
    UpdateCreatedmdevFunc(nullptr);
...
HWTEST_F(LibFsDmTest, FsDmCreateDevice_004, TestSize.Level0)
{
    ...
    UpdateLoaddmdevicetableFunc(loadDmFunc);
    ActivedmdeviceFunc activeDeviceFunc = [](int, const char*) -> int {
        return -1;
    };
    UpdateActivedmdeviceFunc(activeDeviceFunc);
    char *dmDevPath = nullptr;
    int ret = FsDmCreateDevice(&dmDevPath, "devname", nullptr);
    UpdateOpenFunc(nullptr);
    UpdateCreatedmdevFunc(nullptr);
...
HWTEST_F(LibFsDmTest, FsDmCreateDevice_005, TestSize.Level0)
{
    ...
    UpdateActivedmdeviceFunc(activeDeviceFunc);
    GetdmdevpathFunc getDmDevPathFunc = [](int fd, char **dmDevPath, const char *devName) -> int {
        return -1;
    };
    UpdateGetdmdevpathFunc(getDmDevPathFunc);
    char *dmDevPath = nullptr;
    int ret = FsDmCreateDevice(&dmDevPath, "devname", nullptr);
    UpdateOpenFunc(nullptr);
    UpdateCreatedmdevFunc(nullptr);
    UpdateLoaddmdevicetableFunc(nullptr);
    UpdateActivedmdeviceFunc(nullptr);
    UpdateGetdmdevpathFunc(nullptr);
    EXPECT_EQ(ret, -1);
}
