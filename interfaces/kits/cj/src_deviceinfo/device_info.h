...
public:
    ...
    static int64_t CjGetSdkMinorApiVersion();
    static int64_t CjGetSdkPatchApiVersion();
    ...
    static bool CjApiAvailableByInt(int32_t majorVersion);
    static bool CjApiAvailableByStr(const char* version);
};
